...
// Generated 09 Jul 2018

#include "invoker.h"

//ADDRESS NOT FOUND	static BOOL _0xAE3FEE8709B39DCB(Vehicle vehicle) { return invoke<BOOL>(0xAE3FEE8709B39DCB, vehicle); } // 0xAE3FEE8709B39DCB 0xE39DAF36
//ADDRESS NOT FOUND	static void NETWORK_STOP_LOAD_SCENE() { invoke<Void>(0x64E630FAF5F60F44); } // 0x64E630FAF5F60F44 0x24857907
//ADDRESS NOT FOUND	static void _0x7EEC2A316C250073(Any p0, Any p1, Any p2) { invoke<Void>(0x7EEC2A316C250073, p0, p1, p2); } // 0x7EEC2A316C250073 0x30558CFD
//ADDRESS NOT FOUND	static void APP_SET_INT(char* property, int value) { invoke<Void>(0x607E8E3D3E4F9611, property, value); } // 0x607E8E3D3E4F9611 0x1B509C32
//ADDRESS NOT FOUND	static void APP_SET_FLOAT(char* property, float value) { invoke<Void>(0x25D7687C68E0DAA4, property, value); } // 0x25D7687C68E0DAA4 0xF3076135
//ADDRESS NOT FOUND	static void APP_SET_STRING(char* property, char* value) { invoke<Void>(0x3FF2FCEC4B7721B4, property, value); } // 0x3FF2FCEC4B7721B4 0x23DF19A8
//ADDRESS NOT FOUND	static void APP_SET_APP(char* appName) { invoke<Void>(0xCFD0406ADAF90D2B, appName); } // 0xCFD0406ADAF90D2B 0x8BAC4146
//ADDRESS NOT FOUND	static void APP_SET_BLOCK(char* blockName) { invoke<Void>(0x262AB456A3D21F93, blockName); } // 0x262AB456A3D21F93 0xC2D54DD9
//ADDRESS NOT FOUND	static void APP_CLEAR_BLOCK() { invoke<Void>(0x5FE1DF3342DB7DBA); } // 0x5FE1DF3342DB7DBA 0xDAB86A18
//ADDRESS NOT FOUND	static void APP_CLOSE_APP() { invoke<Void>(0xE41C65E07A5F05FC); } // 0xE41C65E07A5F05FC 0x03767C7A
//ADDRESS NOT FOUND	static void APP_CLOSE_BLOCK() { invoke<Void>(0xE8E3FCF72EAC0EF8); } // 0xE8E3FCF72EAC0EF8 0xED97B202
//ADDRESS NOT FOUND	static BOOL APP_HAS_LINKED_SOCIAL_CLUB_ACCOUNT() { return invoke<BOOL>(0x71EEE69745088DA0); } // 0x71EEE69745088DA0 0xD368BA15
//ADDRESS NOT FOUND	static BOOL APP_HAS_SYNCED_DATA(char* appName) { return invoke<BOOL>(0xCA52279A7271517F, appName); } // 0xCA52279A7271517F 0x1DE2A63D
//ADDRESS NOT FOUND	static void APP_SAVE_DATA() { invoke<Void>(0x95C5D356CDA6E85F); } // 0x95C5D356CDA6E85F 0x84A3918D
//ADDRESS NOT FOUND	static Any APP_GET_DELETED_FILE_STATUS() { return invoke<Any>(0xC9853A2BE3DED1A6); } // 0xC9853A2BE3DED1A6 0x784D550B
//ADDRESS NOT FOUND	static BOOL APP_DELETE_APP_DATA(char* appName) { return invoke<BOOL>(0x44151AEA95C8A003, appName); } // 0x44151AEA95C8A003 0x2A2FBD1C
//ADDRESS NOT FOUND	static BOOL LOAD_ALL_PATH_NODES(BOOL keepInMemory) { return invoke<BOOL>(0x80E4A6EDDB0BE8D9, keepInMemory); } // 0x80E4A6EDDB0BE8D9 0xC66E28C3
//ADDRESS NOT FOUND	static Any _0xA306F470D1660581() { return invoke<Any>(0xA306F470D1660581); } // 0xA306F470D1660581
//ADDRESS NOT FOUND	static BOOL NETWORK_IS_IN_PARTY() { return invoke<BOOL>(0x966C2BC2A7FE3F30); } // 0x966C2BC2A7FE3F30 0xF9D7D67D
//ADDRESS NOT FOUND	static BOOL NETWORK_IS_PARTY_MEMBER(int* networkHandle) { return invoke<BOOL>(0x676ED266AADD31E0, networkHandle); } // 0x676ED266AADD31E0 0x1D0C929D
//ADDRESS NOT FOUND	static void _0x77FADDCBE3499DF7(Any p0) { invoke<Void>(0x77FADDCBE3499DF7, p0); } // 0x77FADDCBE3499DF7 0x8179C48A
//ADDRESS NOT FOUND	static void NETWORK_SPENT_FROM_ROCKSTAR(int bank, BOOL p1, BOOL p2) { invoke<Void>(0x6A445B64ED7ABEB5, bank, p1, p2); } // 0x6A445B64ED7ABEB5 0x54198922
//ADDRESS NOT FOUND	static void NETWORK_SPENT_PLAYER_HEALTHCARE(Any p0, Any p1, BOOL p2, BOOL p3) { invoke<Void>(0x7C99101F7FCE2EE5, p0, p1, p2, p3); } // 0x7C99101F7FCE2EE5 0x3D96A21C
//ADDRESS NOT FOUND	static BOOL NETWORK_CAN_RECEIVE_PLAYER_CASH(Any p0, Any p1, Any p2, Any p3) { return invoke<BOOL>(0x5D17BE59D2123284, p0, p1, p2, p3); } // 0x5D17BE59D2123284 0x41F5F10E

namespace PLAYER
{
	static int GET_PLAYER_PED(char* Gamertag) { return invoke<int>(0xFBBE70, Gamertag); } // 0x43A66C31C68491C0 0x6E31E993
	static Ped GET_PLAYER_PED_SCRIPT_INDEX(Player player) { return invoke<Ped>(0xFBBED0, player); } // 0x50FAC3A3E030A6E1 0x6AC64990
	static void SET_PLAYER_MODEL(Player player, Hash modelHash) { invoke<Void>(0xFBBF10, player, modelHash); } // 0x00A1CADD00108836 0x774A4C54
	static void CHANGE_PLAYER_PED(Player player, Ped ped, BOOL p2, BOOL p3) { invoke<Void>(0xFBBF20, player, ped, p2, p3); } // 0x048189FAC643DEEE 0xBE515485
	...
	static int GET_NUMBER_OF_PLAYERS() { return invoke<int>(0xFBBFB0); } // 0x407C7F91DDB46C16 0x4C1B8867
	...
	static void SET_PLAYER_WANTED_CENTRE_POSITION(Player player, float x, float y, float z) { invoke<Void>(0xFBC270, player, x, y, z); } // 0x520E541A97A13354 0xF261633A
	...
	static void SET_POLICE_RADAR_BLIPS(Any toggle) { invoke<Void>(0xFBC860, toggle); } // 0x43286D561B72B8BF 0x8E114B10
	...
	static Player IS_PLAYER_FREE_FOR_AMBIENT_TASK(Vehicle player) { return invoke<Player>(0xFBDA30, player); } // 0xDCCFD3F106C36AB4 0x85C7E232
	...
	static int GIVE_ACHIEVEMENT_TO_PLAYER(int achievement) { return invoke<int>(0xFBDC90, achievement); } // 0xBEC7076D64130195 0x822BC992
	...
	static void _0xC9A763D8FE87436A(Cam player) { invoke<Void>(0xFBE7C0, player); } // 0xC9A763D8FE87436A 0x4136829A
	...
	static void SPECIAL_ABILITY_CHARGE_MEDIUM(Player player, Vehicle p1, Vehicle p2) { invoke<Void>(0xFBE880, player, p1, p2); } // 0xF113E3AA9BC54613 0xAB55D8F3
	...
	static Vehicle IS_SPECIAL_ABILITY_ACTIVE(Ped player) { return invoke<Vehicle>(0xFBEB90, player); } // 0x3E5F7FC85D854E15 0x1B17E334
...
namespace ENTITY
{
	static BOOL DOES_ENTITY_EXIST(Entity entity) { return invoke<BOOL>(0xEED0B0, entity); } // 0x7239B21A38F536BA 0x3AC90869
	...
	static void _SET_USED_BY_PLAYER(Entity entity, BOOL toggle) { invoke<Void>(0xEEF310, entity, toggle); } // 0x694E00132F2823ED 0x40C84A74
	...
	static BOOL PLAY_SYNCHRONIZED_ENTITY_ANIM(Entity entity, int SceneID, char* animName, char* animDict, float speed, float speedMult, int flag, float flag2) { return invoke<BOOL>(0xEEFD50, entity, SceneID, animName, animDict, speed, speedMult, flag, flag2); } // 0xC77720A12FE14A86 0x012760AA
	...
	static void SET_ENTITY_ONLY_DAMAGED_BY_RELATIONSHIP_GROUP(Entity entity, BOOL p1, Hash relationshipHash) { invoke<Void>(0xEF0A60, entity, p1, relationshipHash); } // 0x7022BD828FA0B082 0x202237E2
	...
	static void REMOVE_FORCED_OBJECT(float posX, float posY, float posZ, float unk, Hash modelHash) { invoke<Void>(0xEF18D0, posX, posY, posZ, unk, modelHash); } // 0x61B6775E83C0DB6F 0xAED73ADD
...
namespace PED
{
	...
	static void SET_PED_MIN_GROUND_TIME_FOR_STUNGUN(Ped ped, int ms1000000) { invoke<Void>(0xFA5590, ped, ms1000000); } // 0xFA0675AB151073FA 0x2F0D0973
	...
	static void APPLY_DAMAGE_TO_PED(Ped ped, int damageAmount, BOOL armorFirst) { invoke<Void>(0xFA6790, ped, damageAmount, armorFirst); } // 0x697157CED63F18D4 0x4DC27FCF
	...
	static void _GET_HAIR_COLOR(int colorID, int* R, int* G, int* B) { invoke<Void>(0xFA8B80, colorID, R, G, B); } // 0x4852FC386E2E1BB5
	static void _GET_LIPSTICK_COLOR(int colorID, int* R, int* G, Any* B) { invoke<Void>(0xFA8BD0, colorID, R, G, B); } // 0x013E5CFC38CD5387
	static BOOL _0xED6D8E27A43B8CDE(int ColorID) { return invoke<BOOL>(0xFA8C20, ColorID); } // 0xED6D8E27A43B8CDE
	...
	static void SET_DRIVER_RACING_MODIFIER(Ped driver, float racingModifier) { invoke<Void>(0xFA9D40, driver, racingModifier); } // 0xDED5AF5A0EA4B297 0x6D55B3B3
	...
	static void REMOVE_SCENARIO_BLOCKING_AREA(int areaHandle, BOOL p1) { invoke<Void>(0xFAB930, areaHandle, p1); } // 0x31D16B74C6E29D66 0x4483EF06
	...
	static void SET_FACIAL_IDLE_ANIM_OVERRIDE(Ped ped, char* animName, Any animDict) { invoke<Void>(0xFABF20, ped, animName, animDict); } // 0xFFC24B988B938B38 0x9BA19C13
	...
	static void _0x2B5AA717A181FB4C(Ped ped, BOOL p1) { invoke<Void>(0xFAE820, ped, p1); } // 0x2B5AA717A181FB4C 0x98E29ED0
	...
	static void SET_SYNCHRONIZED_SCENE_ORIGIN(int sceneID, float x, float y, float z, float roll, float pitch, float yaw, int unk) { invoke<Void>(0xFAE970, sceneID, x, y, z, roll, pitch, yaw, unk); } // 0x6ACF6B7225801CD7 0x2EC2A0B2
	...
	static void _SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(int sceneID, BOOL p1) { invoke<Void>(0xFAEBE0, sceneID, p1); } // 0x394B9CD12435C981 0x2DE48DA1
	static BOOL _0x7F2F4F13AC5257EF(int SceneID) { return invoke<BOOL>(0xFAEC30, SceneID); } // 0x7F2F4F13AC5257EF 0x72CF2514
...
//ADDRESS NOT FOUND	static BOOL _0xAE3FEE8709B39DCB(Vehicle vehicle) { return invoke<BOOL>(0xAE3FEE8709B39DCB, vehicle); } // 0xAE3FEE8709B39DCB 0xE39DAF36
	...
	static void _0x8F719973E1445BA2(Vehicle vehicle, BOOL toggle) { invoke<Void>(0x1021F00, vehicle, toggle); } // 0x8F719973E1445BA2 0x35614622
	...
	static void _SET_VEHICLE_FORKLIFT_HEIGHT(Vehicle vehicle, float height) { invoke<Void>(0x10226A0, vehicle, height); } // 0x37EBBF3117BD6A25 0x943A6CFC
	...
	static float GET_TOTAL_DURATION_OF_VEHICLE_RECORDING_ID(int recordingID) { return invoke<float>(0x1023E60, recordingID); } // 0x102D125411A7B6E6 0x7116785E
	...
	static void STOP_PLAYBACK_RECORDED_VEHICLE(Vehicle vehicle) { invoke<Void>(0x1023FD0, vehicle); } // 0x54833611C17ABDEA 0xAE99C57C
	...
	static BOOL IS_PLAYBACK_GOING_ON_FOR_VEHICLE(Vehicle vehicle) { return invoke<BOOL>(0x10240C0, vehicle); } // 0x1C8A4C2C19E68EEC 0x61F7650D
	...
	static int GET_CURRENT_PLAYBACK_FOR_VEHICLE(Vehicle vehicle) { return invoke<int>(0x1024190, vehicle); } // 0x42BC05C27A946054 0xA3F44390
	...
	static Vehicle IS_VEHICLE_DOOR_FULLY_OPEN(Vehicle v, int rwing) { return invoke<Vehicle>(0x10254D0, v, rwing); } // 0x3E933CFF7B111C22 0xC2385B6F
	...
	static void SET_VEHICLE_DEFORMATION_FIXED(Any vehicle) { invoke<Void>(0x10265B0, vehicle); } // 0x953DA1E1B12C0491 0xDD2920C8
	...
	static void SET_VEHICLE_BRAKE_LIGHTS(Vehicle vehicle, BOOL p1) { invoke<Void>(0x1029250, vehicle, p1); } // 0x92B35082E0B42F66 0x6D9BA11E
	...
	static BOOL CAN_SHUFFLE_SEAT(Vehicle vehicle, Ped ped) { return invoke<BOOL>(0x102A3D0, vehicle, ped); } // 0x30785D90C956BF35 0xB3EB01ED
	...
	static void _0x4D9D109F63FEE1D4(Vehicle vehicle, BOOL toggle) { invoke<Void>(0x102C640, vehicle, toggle); } // 0x4D9D109F63FEE1D4 0x900C878C
	...
	static void _0x0CDDA42F9E360CA6(Vehicle vehicle, BOOL toggle) { invoke<Void>(0x102D130, vehicle, toggle); } // 0x0CDDA42F9E360CA6 0x9B581DE7
	...
	static void _SET_CARGOBOB_HOOK_POSITION(Vehicle cargobob, float xOffset, float yOffset, int state) { invoke<Void>(0x102D6E0, cargobob, xOffset, yOffset, state); } // 0x877C1EAEAC531023 0x3A8AB081
	...
	static void _SET_HELICOPTER_ROLL_PITCH_YAW_MULT_HEALTH(Vehicle helicopter, float multiplier) { invoke<Void>(0x102E470, helicopter, multiplier); } // 0x6E0859B530A365CC 0x6E67FD35
	...
	static void _REQUEST_VEHICLE_SCALEFORM_MOVIE(Vehicle vehicle) { invoke<Void>(0x102EF30, vehicle); } // 0xDBA3C090E3D74690
...
namespace OBJECT
{
	...
	static void _ENABLE_OBJECT_LOD(Object object, BOOL toggle) { invoke<Void>(0xF77410, object, toggle); } // 0x77F33F2CCF64B3AA 0x483C5C88
...
namespace AI
{
	static void TASK_PAUSE(Ped ped, int time) { invoke<Void>(0xFFB170, ped, time); } // 0xE73A266DB0CA9042 0x17A64668
	...
	static void TASK_AIM_GUN_AT_ENTITY(Ped ped, Entity entity, int duration, BOOL unk) { invoke<Void>(0xFFCC30, ped, entity, duration, unk); } // 0x9B53BB6E8943AF53 0xBE32B3B6
	...
	static void _TASK_VEHICLE_FOLLOW(Ped driver, Vehicle vehicle, Entity targetEntity, float speed, int drivingStyle, int minDistance) { invoke<Void>(0xFFD010, driver, vehicle, targetEntity, speed, drivingStyle, minDistance); } // 0xFC545A9F0626E3B6
	...
	static Any ADD_COVER_POINT(float posX, float posY, float posZ, float heading, BOOL p4, int p5, BOOL p6, BOOL p7) { return invoke<Any>(0xFFDA30, posX, posY, posZ, heading, p4, p5, p6, p7); } // 0xD5C12A75C7B9497F 0xA0AF0B98
	...
	static void TASK_COMBAT_PED_TIMED(Any p0, Ped ped, int duration, Any p3) { invoke<Void>(0xFFDCA0, p0, ped, duration, p3); } // 0x944F30DCB7096BDE 0xF5CA2A45
	...
	static void TASK_EXIT_COVER(Ped ped, int p1, float posX, float posY, float posZ) { invoke<Void>(0xFFDE60, ped, p1, posX, posY, posZ); } // 0x79B258E397854D29 0xC829FAC9
	static void TASK_PUT_PED_DIRECTLY_INTO_MELEE(Ped ped, Ped target, float p2, float p3, float p4, float flag) { invoke<Void>(0xFFDE80, ped, target, p2, p3, p4, flag); } // 0x1C6CD14A876FFE39 0x79E1D27D
	...
	static void TASK_VEHICLE_SHOOT_AT_PED(Ped ped, Ped target, float flag) { invoke<Void>(0xFFF250, ped, target, flag); } // 0x10AB107B887214D8 0x59677BA0
	...
	static float GET_PED_WAYPOINT_DISTANCE(Ped ped) { return invoke<float>(0xFFF980, ped); } // 0xE6A877C64CAF1BC5 0x084B35B0
	static Any SET_PED_WAYPOINT_ROUTE_OFFSET(Ped ped, float offsetX, float offsetY, float offsetZ) { return invoke<Any>(0xFFFA10, ped, offsetX, offsetY, offsetZ); } // 0xED98E10B0AFCE4B4 0xF867F747
	...
	static void _WAYPOINT_PLAYBACK_START_SHOOTING_AT_PED(Any p0, Any p1, BOOL p2, Any p3) { invoke<Void>(0xFFFFF0, p0, p1, p2, p3); } // 0xE70BA7B90F8390DC
	...
	static Any GET_VEHICLE_WAYPOINT_TARGET_POINT(Ped ped) { return invoke<Any>(0x1000300, ped); } // 0x416B62AC8B9E5BBD 0x81049608
	...
	static Any _0xAB13A5565480B6D9(Ped ped, char* unk) { return invoke<Any>(0x10007D0, ped, unk); } // 0xAB13A5565480B6D9
	...
	static void TASK_SWEEP_AIM_ENTITY(Ped ped, char* animDict, char* animName1, char* animName2, char* animName3, int duration, Entity entity, float p7, float p8) { invoke<Void>(0x1000E90, ped, animDict, animName1, animName2, animName3, duration, entity, p7, p8); } // 0x2047C02158D6405A 0x4D210467
	...
	static void TASK_SWEEP_AIM_POSITION(Ped ped, char* animDict, char* animName1, char* animName2, char* animName3, int timeout, float X, float Y, float Z, float unk, float flag) { invoke<Void>(0x1000EE0, ped, animDict, animName1, animName2, animName3, timeout, X, Y, Z, unk, flag); } // 0x7AFE8FDC10BC07D2 0x1683FE66
	static void UPDATE_TASK_SWEEP_AIM_POSITION(Ped ped, float X, float Y, float Z) { invoke<Void>(0x1000F20, ped, X, Y, Z); } // 0xBB106883F5201FC4 0x6345EC80
...
namespace GAMEPLAY
{
	...
	static float GET_RAIN_LEVEL() { return invoke<float>(0xF2B500); } // 0x96695E368AD855F3 0xC9F67F28
	static float GET_SNOW_LEVEL() { return invoke<float>(0xF2B520); } // 0xC5868A966E5BE3AE 0x1B09184F
	...
	static void SET_SAVE_HOUSE(int index, BOOL p1, BOOL p2) { invoke<Void>(0xF2CD50, index, p1, p2); } // 0x4F548CABEAE553BC 0xC3240BB4
	...
	static void _SET_SHOW_PED_IN_PAUSE_MENU(BOOL toggle) { invoke<Void>(0xF2FBF0, toggle); } // 0x4EBB7E87AA0DBED4
	static BOOL _GET_SHOW_PED_IN_PAUSE_MENU() { return invoke<BOOL>(0xF2FC10); } // 0x9689123E3F213AA5
...
namespace AUDIO
{
	...
	static BOOL _0xC8B1B2425604CDD0() { return invoke<BOOL>(0xEC1E50); } // 0xC8B1B2425604CDD0 0x16FB88B5
	...
	static void ADD_PED_TO_CONVERSATION(int pedIndex, Ped ped, char* name) { invoke<Void>(0xEC1F80, pedIndex, ped, name); } // 0x95D9F4BC443956E7 0xF8D5EB86
	...
	static BOOL _0xE73364DB90778FFA() { return invoke<BOOL>(0xEC2380); } // 0xE73364DB90778FFA 0x336F3D35
	...
	static void _PLAY_AMBIENT_SPEECH_AT_COORDS(char* speechName, char* speechParam, float x, float y, float z, char* p5) { invoke<Void>(0xEC2D20, speechName, speechParam, x, y, z, p5); } // 0xED640017ED337E45 0xA1A1402E
	static void OVERRIDE_TREVOR_RAGE(char* p0) { invoke<Void>(0xEC2DB0, p0); } // 0x13AD665062541A7E 0x05B9B5CF
	static void RESET_TREVOR_RAGE() { invoke<Void>(0xEC2DD0); } // 0xE78503B10C4314E0 0xE80CF0D4
	static void SET_PLAYER_ANGRY(Ped playerPed, BOOL value) { invoke<Void>(0xEC2DE0, playerPed, value); } // 0xEA241BB04110F091 0x782CA58D
	...
	static void _RESET_AMBIENT_VOICE(Ped ped) { invoke<Void>(0xEC3040, ped); } // 0x40CF0D12D142A9E8
	...
	static BOOL _0x0626A247D2405330() { return invoke<BOOL>(0xEC3830); } // 0x0626A247D2405330
	...
	static void _SET_VEHICLE_AS_AMBIENT_EMMITTER(Vehicle vehicle) { invoke<Void>(0xEC3940, vehicle); } // 0xC1805D05E6D4FE10 0x7ABB89D2
	...
	static void STOP_PED_SPEAKING(Ped ped, BOOL speaking) { invoke<Void>(0xEC4890, ped, speaking); } // 0x9D64D7405520E3D3 0xFF92B49D
	...
	static void SET_SIREN_WITH_NO_DRIVER(Vehicle vehicle, BOOL toggle) { invoke<Void>(0xEC49C0, vehicle, toggle); } // 0x1FEF0683B96EBCF2 0x77182D58
	...
	static BOOL _0x6F259F82D873B8B8() { return invoke<BOOL>(0xEC53D0); } // 0x6F259F82D873B8B8 0xCBE09AEC
	...
	static BOOL AUDIO_IS_SCRIPTED_MUSIC_PLAYING() { return invoke<BOOL>(0xEC5650); } // 0x845FFC3A4FEEFA3E 0x86E995D1
	...
	static Any PREPARE_SYNCHRONIZED_AUDIO_EVENT(char* audioName, BOOL unk) { return invoke<Any>(0xEC5F20, audioName, unk); } // 0xC7ABCACA4985A766 0xE1D91FD0
	static BOOL PREPARE_SYNCHRONIZED_AUDIO_EVENT_FOR_SCENE(int SceneID, char* audioName) { return invoke<BOOL>(0xEC5F50, SceneID, audioName); } // 0x029FE7CD1B7E2E75 0x7652DD49
	static BOOL PLAY_SYNCHRONIZED_AUDIO_EVENT(int SceneID) { return invoke<BOOL>(0xEC5FA0, SceneID); } // 0x8B2FD4560E55DD2D 0x507F3241
	static BOOL STOP_SYNCHRONIZED_AUDIO_EVENT(int SceneID) { return invoke<BOOL>(0xEC5FE0, SceneID); } // 0x92D6A88E64A94430 0xADEED2B4
	...
	static BOOL _0x3A48AB4445D499BE() { return invoke<BOOL>(0xEC61C0); } // 0x3A48AB4445D499BE 0x93A44A1F
	...
	static BOOL _0x544810ED9DB6BBE6() { return invoke<BOOL>(0xEC6280); } // 0x544810ED9DB6BBE6
	static BOOL _0x5B50ABB1FE3746F4() { return invoke<BOOL>(0xEC62A0); } // 0x5B50ABB1FE3746F4
}
...
namespace CAM
{
	...
	static BOOL CREATE_CAM(char* camName, BOOL unk) { return invoke<BOOL>(0xECEBF0, camName, unk); } // 0xC3981DCE61D9E13F 0xE9BF2A7D
	...
	static void SET_CAM_ROT(Cam cam, float pitch, float roll, float yaw, int rotationOrder) { invoke<Void>(0xECF5F0, cam, pitch, roll, yaw, rotationOrder); } // 0x85973643155D0B07 0xEE38B3C1
	...
	static void ADD_CAM_SPLINE_NODE(Cam camera, float x, float y, float z, float xRot, float yRot, float zRot, int length, int p8, int transitionType) { invoke<Void>(0xED0560, camera, x, y, z, xRot, yRot, zRot, length, p8, transitionType); } // 0x8609C75EC438FB3B 0xAD3C7EAA
	...
	static int GET_CAM_SPLINE_NODE_INDEX(Cam cam) { return invoke<int>(0xED08E0, cam); } // 0xB22B17DF858716A6 0xF8AEB6BD
	...
	static BOOL PLAY_SYNCHRONIZED_CAM_ANIM(Cam camera, int SceneID, char* animName, char* animDictionary) { return invoke<BOOL>(0xED1270, camera, SceneID, animName, animDictionary); } // 0xE32EFE9AB4A9AA0C 0x9458459E
	...
	static void SET_GAMEPLAY_ENTITY_HINT(Entity entity, float xOffset, float yOffset, float zOffset, BOOL p4, int duration, int fadeInTime, int fadeOutTime, int flags) { invoke<Void>(0xED2EC0, entity, xOffset, yOffset, zOffset, p4, duration, fadeInTime, fadeOutTime, flags); } // 0x189E955A8313E298 0x66C32306
	...
	static float _GET_REPLAY_FREE_CAM_MAX_RANGE() { return invoke<float>(0xED3890); } // 0x8BFCEB5EA1B161B6
}
...
namespace WEAPON
{
	...
	static BOOL GET_CURRENT_PED_WEAPON(Ped ped, Hash* weaponHash, BOOL unused) { return invoke<BOOL>(0x103A7D0, ped, weaponHash, unused); } // 0x3A87E44BB9A01D54 0xB0237302
	...
	static void SET_PED_AMMO_TO_DROP(Any ammoType, int ammo) { invoke<Void>(0x103B5D0, ammoType, ammo); } // 0xA4EFEF9440A5B0EF 0x2386A307
...
//ADDRESS NOT FOUND	static void NETWORK_STOP_LOAD_SCENE() { invoke<Void>(0x64E630FAF5F60F44); } // 0x64E630FAF5F60F44 0x24857907
	...
	static void SET_VEHICLE_POPULATION_BUDGET(int budget) { invoke<Void>(0xFE39D0, budget); } // 0xCB9E1EB3BE2AF4E9 0x1D56993C
	static void SET_PED_POPULATION_BUDGET(int budget) { invoke<Void>(0xFE39F0, budget); } // 0x8C95333CFC3340F3 0xD2D026CD
	...
	static void _SWITCH_OUT_PLAYER(Ped ped, int flags, int switchType) { invoke<Void>(0xFE4580, ped, flags, switchType); } // 0xAAB3200ED59016BC 0xFB4D062D
...
namespace SCRIPT
{
	...
	static void TRIGGER_SCRIPT_EVENT(int eventGroup, Any* args, int argCount, Any bit) { invoke<Void>(0xFC3950, eventGroup, args, argCount, bit); } // 0x5AE99C571D5BBE5D 0x54763B35
...
namespace UI
{
	...
	static BOOL _0xA9CBFD40B3FA3010() { return invoke<BOOL>(0xF165A0); } // 0xA9CBFD40B3FA3010 0xC5223796
	...
	static int _DRAW_NOTIFICATION(BOOL blink, BOOL showInBrief) { return invoke<int>(0xF16B00, blink, showInBrief); } // 0x2ED7843F8F801023 0x08F7AF78
	...
	static Any _0xC8F3AAF93D0600BF(char* p0, int p1, char* p2, Any p3) { return invoke<Any>(0xF16D60, p0, p1, p2, p3); } // 0xC8F3AAF93D0600BF 0x4FA43BA4
	...
	static void END_TEXT_COMMAND_DISPLAY_HELP(Any p0, BOOL loop, BOOL beep, int duration) { invoke<Void>(0xF17080, p0, loop, beep, duration); } // 0x238FFE5C7B0498A6 0xB59B530D
	...
	static void _0x75A16C3DA34F1245(Blip blip, BOOL p1) { invoke<Void>(0xF195C0, blip, p1); } // 0x75A16C3DA34F1245 0x1D99F676
	static void SHOW_TICK_ON_BLIP(Blip blip, BOOL toggle) { invoke<Void>(0xF195E0, blip, toggle); } // 0x74513EA3E505181E 0x3DCF0092
	...
	static void _UPDATE_DISPLAY_CASH(BOOL toggle) { invoke<Void>(0xF19B60, toggle); } // 0x170F541E1CADD1DE
	...
	static void _SET_DISPLAY_CASH() { invoke<Void>(0xF19BF0); } // 0xC2D15BEF167E27BC 0xF4F3C796
	static void _REMOVE_DISPLAY_CASH() { invoke<Void>(0xF19C10); } // 0x95CF81BD06EE1887 0x7BFFE82F
	...
	static BOOL _0x0C5A80A9E096D529(Any p0, char* text, Any p2, Any p3, Any p4, Any p5) { return invoke<BOOL>(0xF1B280, p0, text, p2, p3, p4, p5); } // 0x0C5A80A9E096D529
	...
	static void _0x77F16B447824DA6C(int p0) { invoke<Void>(0xF1B6B0, p0); } // 0x77F16B447824DA6C 0x0A89336C
	...
	static BOOL _0x2E22FEFA0100275E() { return invoke<BOOL>(0xF1B9E0); } // 0x2E22FEFA0100275E 0x96863460
...
namespace GRAPHICS
{
	...
	static void REQUEST_STREAMED_TEXTURE_DICT(char* textureDict, BOOL unused) { invoke<Void>(0xF05A10, textureDict, unused); } // 0xDFA2EF8E04127DD5 0x4C9B035F
	...
	static void _0x5096FD9CCB49056D(char* p0) { invoke<Void>(0xF095F0, p0); } // 0x5096FD9CCB49056D 0x908A335E
	...
	static void DRAW_SCALEFORM_MOVIE_FULLSCREEN(int scaleform, int red, int green, int blue, int alpha, int unk) { invoke<Void>(0xF09B60, scaleform, red, green, blue, alpha, unk); } // 0x0DF606929C105BE1 0x7B48E696
	...
	static BOOL _GET_SCREEN_EFFECT_IS_ACTIVE(char* effectName) { return invoke<BOOL>(0xF0ABE0, effectName); } // 0x36AD3E690DA5ACEB 0x089D5921
...
namespace STATS
{
	...
	static BOOL STAT_GET_POS(Hash statHash, float* x, float* y, float* z, int p4) { return invoke<BOOL>(0xFDBDB0, statHash, x, y, z, p4); } // 0x350F82CCB186AA1B 0xC846ECCE
...
//ADDRESS NOT FOUND	static void _0x7EEC2A316C250073(Any p0, Any p1, Any p2) { invoke<Void>(0x7EEC2A316C250073, p0, p1, p2); } // 0x7EEC2A316C250073 0x30558CFD
	...
	static BOOL _LEADERBOARDS2_WRITE_DATA_EX(Any* p0, Any* p1) { return invoke<BOOL>(0xFDE3C0, p0, p1); } // 0xC980E62E33DF1D5C 0x62C19A3D
...
namespace PATHFIND
{
	...
	static BOOL GET_CLOSEST_MAJOR_VEHICLE_NODE(float x, float y, float z, Vector3* outPosition, float p5, int p6) { return invoke<BOOL>(0xF82330, x, y, z, outPosition, p5, p6); } // 0x2EABE3B06F58C1BE 0x04B5F15B
	...
	static BOOL GET_NTH_CLOSEST_VEHICLE_NODE(float x, float y, float z, int nthClosest, Vector3* outPosition, BOOL p6, float p7, float p8) { return invoke<BOOL>(0xF824F0, x, y, z, nthClosest, outPosition, p6, p7, p8); } // 0xE50E52416CCF948B 0xF125BFCC
	...
	static BOOL GET_NTH_CLOSEST_VEHICLE_NODE_WITH_HEADING(float x, float y, float z, int nthClosest, Vector3* outPosition, float* outHeading, int* outInt, int p6, float p7, float p8) { return invoke<BOOL>(0xF82670, x, y, z, nthClosest, outPosition, outHeading, outInt, p6, p7, p8); } // 0x80CA6A8B6C094CC4 0x7349C856
...
namespace DATAFILE
{
	...
	static Any* _OBJECT_VALUE_GET_OBJECT(Any* sCloudFile, char* key) { return invoke<Any*>(0xEDB0D0, sCloudFile, key); } // 0xB6B9DDC412FCEEE2 0xC9C13D8D
...
namespace FIRE
{
	...
	static int _0x6070104B699B2EF4(int unk, float PosX1, float PosY1, float PosZ1, float PosX2, float PosY2, float PosZ2) { return invoke<int>(0xEF5190, unk, PosX1, PosY1, PosZ1, PosX2, PosY2, PosZ2); } // 0x6070104B699B2EF4
...
namespace ROPE
{
	...
	static void _UPDATE_ROPE(Object rope, BOOL update) { invoke<Void>(0xFB4930, rope, update); } // 0xDC57A637A20006ED 0x80DB77A7
	...
	static void BREAK_ENTITY_GLASS(Object object, float posX, float posY, float posZ, float p4, float offsetX, float offsetY, float offsetZ, float p8, int p9, BOOL p10) { invoke<Void>(0xFB51B0, object, posX, posY, posZ, p4, offsetX, offsetY, offsetZ, p8, p9, p10); } // 0x2E648D16F6E308F3 0xD0E0402F
	...
	static void _0xCC6E963682533882(Object object) { invoke<Void>(0xFB52E0, object); } // 0xCC6E963682533882
...
namespace WATER
{
	...
	static BOOL TEST_PROBE_AGAINST_ALL_WATER(float x1, float y1, float z1, float x2, float y2, float z2, int type, float unkVector) { return invoke<BOOL>(0x10322E0, x1, y1, z1, x2, y2, z2, type, unkVector); } // 0x8974647ED222EA5F 0x4A962D55
...
namespace WORLDPROBE
{
	...
	static void _SHAPE_TEST_RESULT_ENTITY(Hash entityHit) { invoke<Void>(0xFC57C0, entityHit); } // 0x2B3334BCA57CD799 0xEC2AAF06
}
...
namespace NETWORK
{
	...
	static BOOL _0xEBCAB9E5048434F4() { return invoke<BOOL>(0xF602B0); } // 0xEBCAB9E5048434F4
	static BOOL _0x74FB3E29E6D10FA9() { return invoke<BOOL>(0xF602F0); } // 0x74FB3E29E6D10FA9
...
//ADDRESS NOT FOUND	static Any _0xA306F470D1660581() { return invoke<Any>(0xA306F470D1660581); } // 0xA306F470D1660581
	...
	static BOOL _NETWORK_HAS_RESTRICTED_PROFILE() { return invoke<BOOL>(0xF60500); } // 0x1353F87E89946207
	...
	static BOOL NETWORK_IS_MULTIPLAYER_DISABLED() { return invoke<BOOL>(0xF608F0); } // 0x9747292807126EDA 0x05518C0F
	...
	static BOOL NETWORK_FIND_MATCHED_GAMERS(int unk, float p1, float neg1a, float neg1b) { return invoke<BOOL>(0xF61300, unk, p1, neg1a, neg1b); } // 0xF7B2CFDE5C9F700D 0xA13045D4
	static BOOL NETWORK_IS_FINDING_GAMERS() { return invoke<BOOL>(0xF61340); } // 0xDDDF64C91BFCF0AA 0xA6DAA79F
	static BOOL _0xF9B83B77929D8863() { return invoke<BOOL>(0xF61360); } // 0xF9B83B77929D8863 0xBEDC4503
	...
	static void _SERVER_HANDLER() { invoke<Void>(0xF61800); } // 0xF814FEC6A19FD6E0 0x32B7A076
	...
	static BOOL _NETWORK_ANAL_PURPLE777(Any p0) { return invoke<BOOL>(0xF633E0, p0); } // 0x8806CEBFABD3CE05 0x7D593B4C
...
//ADDRESS NOT FOUND	static void _0x77FADDCBE3499DF7(Any p0) { invoke<Void>(0x77FADDCBE3499DF7, p0); } // 0x77FADDCBE3499DF7 0x8179C48A
	...
	static int _NETWORK_GET_PLAYER_PED_FROM_INDEX() { return invoke<int>(0xF648F0); } // 0x638A3A81733086DB 0xDB8B5D71
	...
	static BOOL NETWORK_DOES_ENTITY_EXIST_WITH_NETWORK_ID(int netId) { return invoke<BOOL>(0xF65050, netId); } // 0x18A47D074708FD68 0x1E2E3177
	...
	static void _NETWORK_RESPAWN_PLAYER(Player player, BOOL p1) { invoke<Void>(0xF675B0, player, p1); } // 0xBF22E0F32968E967 0x22E03AD0
	...
	static BOOL _NETWORK_GET_PLAYER_CREW_EMBLEM_TXD_NAME(Player* player, Any* p1) { return invoke<BOOL>(0xF67B50, player, p1); } // 0x5835D9CD92E83184 0xBA672146
	...
	static char* GET_PLAYER_ADVANCED_MODIFIER_PRIVILEGES(int p0) { return invoke<char*>(0xF6CC00, p0); } // 0xCD67AD041A394C9C 0x8F3137E6
	...
	static void _NETWORK_UPDATE_PLAYER_SCARS() { invoke<Void>(0xF6E0E0); } // 0xB7C7F6AD6424304B 0x371BBA08
...
//ADDRESS NOT FOUND	static BOOL NETWORK_CAN_RECEIVE_PLAYER_CASH(Any p0, Any p1, Any p2, Any p3) { return invoke<BOOL>(0x5D17BE59D2123284, p0, p1, p2, p3); } // 0x5D17BE59D2123284 0x41F5F10E
	...
	static BOOL _0x6FCF8DDEA146C45B(int p0) { return invoke<BOOL>(0xF40C00, p0); } // 0x6FCF8DDEA146C45B 0xB96C7ABE
}

namespace DLC1
{
	static int _GET_NUM_DECORATIONS(int character) { return invoke<int>(0xEDE470, character); } // 0x278F76C3B0A8F109 0x71D0CF3E
	static BOOL _0xFF56381874F82086(int character, int p1, int* outComponent) { return invoke<BOOL>(0xEDE4A0, character, p1, outComponent); } // 0xFF56381874F82086 0x2E9D628C
...
namespace SOCIALCLUB
{
	...
	static BOOL _0xBC1CC91205EC8D6E() { return invoke<BOOL>(0xFC8010); } // 0xBC1CC91205EC8D6E 0x6C5738AB
	static char* _0xDF649C4E9AFDD788() { return invoke<char*>(0xFC8020); } // 0xDF649C4E9AFDD788 0x468668F0
	...
	static Vector3* _INFAMOUS_BY_ENOUGH007_BITCH() { return invoke<Vector3*>(0xFC8FC0); } // 0x198D161F458ECC7F
...
namespace UNK3
{
	static int _NETWORK_SHOP_GET_PRICE(Hash itemHash, Hash categoryHash, BOOL p2) { return invoke<int>(0xF42490, itemHash, categoryHash, p2); } // 0xC27009422FCCA88D
	...
	static BOOL _NETWORK_SHOP_CHECKOUT_START(Any p0) { return invoke<BOOL>(0xF42620, p0); } // 0x39BE7CEA8D9CC8E6
